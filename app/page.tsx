  ...
  return (
    <div>
      <main className="flex min-h-screen flex-col items-center justify-between">
        {/* Hero Section */}
        <FadeInWhenVisible variant="dark">
          <div
              ...
              <div className="px-4 sm:px-8 md:px-12 lg:px-20">
                <div className="flex flex-col gap-6">
                  ...
                  >
                    ...
                    order to help the Solaris Space Agency save the colonists on
                    the Moon's Tranquility Base.
                  </p>
                  ...
                  >
                    ...
                    education is a must for all high schoolers. We believe that
                    STEM education in high school is quite lackluster, and have
                    partnered with Hack Club to provide real-world Computer
                    Science and experience to all high schoolers, regardless of
                    prior experience.
                  </p>
                </div>
              </div>{" "}
        ...
        {/* Sponsors Section */}
        <FadeInWhenVisible delay={0.3} variant="dark">
          <div className="bg-black/[.89] py-20">
            <div className="max-w-6xl mx-auto px-4 sm:px-8">
              <div className="flex flex-col items-center">
                ...
                >
                  Companies that rock and are providing us with the opportunity
                  to educate high schoolers.
                </p>
              </div>
        ...
        {/* FAQ Section */}
        <FadeInWhenVisible delay={0.4} variant="light">
                  ...
                  >
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent className="text-black/80">
                        ...
                        turn their ideas into reality through coding, designing,
                        and building projects. Think of it as an invention
                        marathon where you can learn new skills, meet amazing
                        people, and create something awesome - all in 24 hours!
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent className="text-black/80">
                        Not at all! Hackathons are perfect for beginners. We'll
                        have workshops, mentors, and resources to help you
                        learn. Many participants come with zero coding
                        experience and leave having built their first project.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent className="text-black/80">
                        Bring your laptop, charger, and any other devices you
                        might need. We'll provide food, drinks, snacks, and a
                        comfortable space to work. Don't forget a sleeping bag
                        or blanket if you plan to rest!
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-7">
                      ...
                      <AccordionContent className="text-black/80">
                        We're currently in talks with several potential venues
                        in the New Jersey area and potentially the Greater New
                        York Area. We're looking for a spacious, accessible
                        location that can comfortably accommodate all our
                        hackers with the necessary amenities and technical
                        infrastructure. We'll announce the final venue as soon
                        as we secure the perfect spot for an amazing hackathon
                        experience!
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                  ...
                  >
                    <AccordionItem value="item-4">
                      ...
                      <AccordionContent className="text-black/80">
                        ...
                        sky's the limit. We'll have themed prize tracks and
                        sponsors who can help guide your project, but you're
                        free to build whatever interests you most.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-5">
                      ...
                      <AccordionContent className="text-black/80">
                        Nothing! The event is completely free for all
                        participants. We provide meals, snacks, swag, and
                        everything you need to have an amazing experience,
                    ...
                    <AccordionItem value="item-8">
                      ...
                      <AccordionContent className="text-black/80">
                        ...
                        participation. Stay tuned to our social media channels
                        for the official date announcement!
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </div>
        ...
        {/* Footer Section */}
        <FadeInWhenVisible delay={0.5} variant="dark">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8">
              <div className="flex justify-between items-start">
                ...
                <div className="flex flex-col gap-2">
                  <p
                    className={`${beVietnamPro.className} text-sm text-white/80`}
                  >
        ...
        {/* Keep your existing envelope and dialog components */}
        <AnimatePresence>
          {showEnvelope && (
            <motion.div
